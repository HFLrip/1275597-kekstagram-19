...
(function () {
  ...
  bigPicture.querySelector('.big-picture__img').src = window.data.photoDescriptions[0].url;
  ...
  for (var k = 0; k < window.data.photoDescriptions[0].comments.length; k++) {
    var commentItem = document.createElement('li');
    commentItem.classList.add('social__comment');
    commentList. appendChild(commentItem);
    var socialPicture = document.createElement('img');
    socialPicture.classList.add('social__picture');
    socialPicture.src = window.data.photoDescriptions[0].comments[k].avatar;
    socialPicture.alt = window.data.photoDescriptions[0].comments[k].name;
    commentItem.appendChild(socialPicture);
    var textComment = document.createElement('p');
    textComment.textContent = window.data.photoDescriptions[0].comments[k].message;
